...
const SettingsComponentsMs = () => {
    return (
        <PaddingContainer>
            <FlexContainer direction="column" gap="2rem">
                <div>
                    <SettingsContainer>
                        <Link to="/mahasiswa/edit-profile"><span><HiOutlineUserCircle />Edit Profile</span><HiMiniChevronRight /></Link>
                        <Link to="/mahasiswa/ganti-password"><span><HiOutlineKey />Ganti Password</span><HiMiniChevronRight /></Link>
...
export default SettingsComponentsMs